...
namespace SistemasTutorInteligente.Controllers
{
    public class EjerciciosController : Controller
    {
        ...
        public EjerciciosController(SistemasTutorInteligenteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IDejercicio,NombreEjercicio,Puntaje")] Ejercicio ejercicio)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ejercicio = await _context.Ejercicio.SingleOrDefaultAsync(m => m.IDejercicio == id);
            if (ejercicio == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDejercicio,NombreEjercicio,Puntaje")] Ejercicio ejercicio)
        {
